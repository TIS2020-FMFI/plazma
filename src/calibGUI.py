...
class CalibrationGui:
    def __init__(self, main_gui):
        ...
        port1_length_label = tk.Label(calibration_frame, text="PORT1 Length/(ps):",
        ...
        port2_length_label = tk.Label(calibration_frame, text="PORT2 Length/(ps): ", fg='#323338', bg="#f2f3fc",
                                      font=widget_port_font)
